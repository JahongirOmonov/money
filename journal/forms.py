...
class ArticleForm(forms.ModelForm):
    class Meta:
        model = Article
        fields = (
        'title', 'title_uz', 'title_en', 'title_ru', 'authors', 'content', 'content_uz', 'content_en', 'content_ru')
...
class PostForm(forms.ModelForm):
    class Meta:
        model = Post
        fields = (
        'title', 'title_uz', 'title_en', 'title_ru', 'content', 'content_uz', 'content_en', 'content_ru', 'mediaImage')
...
class AboutForm(forms.ModelForm):
    class Meta:
        model = About
        fields = (
        'journal_name', 'journal_name_uz', 'journal_name_en', 'journal_name_ru', 'content', 'content_uz', 'content_en',
        'content_ru',
        'journal_image',
